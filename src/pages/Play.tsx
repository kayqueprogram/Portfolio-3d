...
const Play = () => {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    { role: 'assistant', content: 'Olá! 👋 Posso contar sobre o Kayque, seus projetos e sua stack. O que você gostaria de saber?' }
  ]);
      ...
      <div className="chess-container">
        ...
        <div className="chat-panel">
          <div className="chat-header">
            <span className="chat-title">💬 Converse comigo</span>
          </div>
          ...
          <div className="player-bar opponent-bar">
            <div className="player-info">
              <div className="player-avatar">
                <img src="/images/kayque.png" alt="Kayque de Jesus" />
              </div>
              <div className="player-details">
                <span className="player-name">Kayque Bot</span>
                <span className="player-rating">{engineThinking ? '🤔 Pensando...' : 'Modo desafio'}</span>
              </div>
            </div>
